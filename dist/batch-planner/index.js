...
exports.default = (() => {
  var _ref3 = _asyncToGenerator(function* (sqlAST, data, dbCall, context, options) {
    ...
    return Promise.all(children.map((() => {
      var _ref4 = _asyncToGenerator(function* (childAST) {
        var _ref;
        ...
        if (childAST.sqlBatch || ((_ref = childAST) != null ? (_ref = _ref.junction) != null ? _ref.sqlBatch : _ref : _ref)) {
          var _ref2;
          ...
          } else if ((_ref2 = childAST) != null ? (_ref2 = _ref2.junction) != null ? _ref2.sqlBatch : _ref2 : _ref2) {
